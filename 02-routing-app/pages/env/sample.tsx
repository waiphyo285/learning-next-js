...
const Code = (p: any) => <code {...p} />;

const IndexPage = () => (
  <div className={styles.hello}>
    <Title title={"ENV Demo"} sub_title={"/env/sample"} />

    <p>
      In the table below you will see how environment variables can be exposed
      to the browser with Next.js.
    </p>
    ...
    <p>
      Variables in <Code>.env.production</Code> will not be available if the app
    ...
    <p>
      Similarly, variables in <Code>.env.development</Code> will not be
